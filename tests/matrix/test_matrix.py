...
print("\n(4a) - transpose()")
print(">>> m_4a = Matrix('m_4a',2,3,[1,2,3,4,5,6])")
print(">>> m_4a_T = m_4a.transpose()")
print(">>> print(m_4a)")
print(">>> print(m_4a_T)")
m_4a = Matrix('m_4a',2,3,[1,2,3,4,5,6])
m_4a_T = m_4a.transpose()
print(m_4a)
print(m_4a_T)

print("\n(4b) - Inplace Transpose")
print(">>> m_4b = Matrix('m_4b',2,3,[1,2,3,4,5,6])")
print(">>> m_4b.transpose(True)")
print(">>> print(m_4b)")
m_4b = Matrix('m_4b',2,3,[1,2,3,4,5,6])
m_4b.transpose(True)
print(m_4b)

print("\n(4c) - Trace")
print(">>> m_4c = Matrix(3,3,[1,2,3,4,5,6,7,8,9])")
print(">>> tr = m_4c.trace()")
print(">>> print(m_4c)")
print(">>> print('trace = ',tr)")
m_4c = Matrix(3,3,[1,2,3,4,5,6,7,8,9])
tr = m_4c.trace()
print(m_4c)
print('trace = ',tr)
...
print("\n(4) Error handling")
print("\n(4a) - Out of bounds")
print(">>> A = Matrix('A',[[1,2],[3,2]])")
print(">>> row3 = A.get_row(2)")
print(">>> err = A.get_info()")
print(">>> print(err)")
A = Matrix('A',[[1,2],[3,2]])
row3 = A.get_row(2)
err = A.get_info()
...
print("\n(4b) - Incompatible rows")
print(">>> A = Matrix('A',[[1,2],[2,3]])")
print(">>> B = Matrix('B',[[1,2],[2,3],[4,5]])")
print(">>> C = A + B")
print(">>> err = A.get_info()")
print(">>> print(err)")
A = Matrix('A',[[1,2],[2,3]])
B = Matrix('B',[[1,2],[2,3],[4,5]])
C = A + B
err = A.get_info()
print(err)

print("\n(4c) - Incompatible cols")
print(">>> A = Matrix('A',[[1,2],[2,3]])")
print(">>> B = Matrix('B',[[1,2,3],[2,3,4])")
print(">>> C = A + B")
print(">>> err = A.get_info()")
print(">>> print(err)")
A = Matrix('A',[[1,2],[2,3]])
B = Matrix('B',[[1,2,3],[2,3,4]])
C = A + B
err = A.get_info()
print(err)

print("\n(4d) - Inconsistent array")
print(">>> A = Matrix('A',[[1,2],[1,2,3]])")
print(">>> err = A.get_info()")
print(">>> print(err)")
A = Matrix('A',[[1,2],[1,2,3]])
err = A.get_info()
print(err)
